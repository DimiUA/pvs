...
function getPlusInfo() {
    ...
    if (window.device) {
        ...
        localStorage.PUSH_APPID_ID = 'android.app.quiktrak.eu.pvs';
        localStorage.DEVICE_TYPE = "android.app.quiktrak.eu.pvs";
    }
}
...
API_URL.URL_USERGUIDE = "https:/helper.quiktrak.com.au/manuals/pvs/app-user-manual.pdf";
...
function getNotificationList() {
    var ret = {};
    var str = localStorage.getItem("COM.QUIKTRAK.LIVE.NOTIFICATIONLIST.BW");
    if (str) { ret = JSON.parse(str); }
    return ret;
}
